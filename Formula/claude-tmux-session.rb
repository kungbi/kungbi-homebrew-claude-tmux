class ClaudeTmuxSession < Formula
  ...
  url "https://github.com/kungbi/claude-tmux-session/archive/refs/tags/v0.2.0.tar.gz"
  sha256 "e1bb4d5d79bafc167ea4f920c441c237578d8b9cf099ba62e3b41434a74f2e0b"
  license "MIT"
